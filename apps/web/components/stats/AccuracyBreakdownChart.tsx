  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <BarChart
        ...
        barSize={28}
      >
        <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="rgb(255 255 255 / 0.06)" />
        <XAxis
          dataKey="name"
          tick={({ x, y, payload }) => (
            <text
              ...
              textAnchor="middle"
              fontSize={11}
              fill={data.find((d) => d.name === payload.value)?.isMe ? 'rgb(217 119 87)' : 'rgb(107 100 92)'}
        ...
        <Bar dataKey="miss" name="Miss" stackId="a" fill="rgb(58 55 51)" radius={[4, 4, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  )
}

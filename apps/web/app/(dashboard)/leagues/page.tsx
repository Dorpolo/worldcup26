    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-8">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-semibold" style={{ color: 'rgb(240 235 227)' }}>No leagues yet</h2>
          <p className="text-sm" style={{ color: 'rgb(107 100 92)' }}>Create a league or join one with an invite link.</p>
        </div>
